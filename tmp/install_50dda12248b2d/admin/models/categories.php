...
class SimpleCalendarModelCategories extends JModel {
	...
	function _buildQuery() {
	    ...
	    $query = 'SELECT * FROM #__simplecal_categories AS a ' . $orderby;
    	return $query;
  	}
...
//		$context = 'com_simplecalendar.categories.';
		...
		$filter_order		= $mainframe->getUserStateFromRequest( 'filter_order',		'filter_order',		'a.ordering',	'cmd' );
	...
	function checkBeforeDelete() {
		...
		foreach ($cids as $cid) {
			$_query = 'SELECT COUNT(*) FROM #__simplecal WHERE categoryID = ' . (int) $cid;
			$db->setQuery($_query);
